  ...
  <div>
    <div>
      ...
      <ul class="pb-8 pl-2 space-y-3">
        ...
        <li>
          <NuxtLink :to="localePath('/')" class="sidebar-link">Second Link</NuxtLink>
        </li>
        <li>
          <NuxtLink :to="localePath('/')" class="sidebar-link">Third Link</NuxtLink>
        </li>
        <li>
          <NuxtLink :to="localePath('/')" class="sidebar-link">Fourth Link</NuxtLink>
        </li>
      </ul>
    </div>
    <div>
...
<style scoped>
.sidebar-heading {
  @apply uppercase font-medium pb-3 text-xl;
}

.sidebar-link {
  @apply block p-2 font-normal text-black rounded;
}
