<template>
  <div class="py-4 px-2 flex flex-col md:flex-row items-center justify-between bg-gradient-to-r from-gray-700 to-gray-900">
    ...
    <!-- phone & email -->
    <div class="py-1 md:py-0 flex-grow flex items-stretch justify-center">
      <div class="flex items-center mr-4">
        <div class="mr-2">
          <svg class="w-6 text-gray-200 hover:text-gray-400" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
    ...
    <div class="flex flex-col items-end">
      <ul class="flex items-center justify-between mb-4">
        <li class="group bg-gray-200 py-2 px-4 rounded-l flex items-center">
          ...
          <a href="http://edu.uz/uz/pages/ilm-fan-2020e" target="_blank" rel="nofollow noopener" class="group-hover:text-blue-700 text-black font-semibold text-xs hover:no-underline">Ilm-Fan 2020</a>
        </li>
        <li class="group bg-gray-200 py-2 px-4 border-r-2 border-l-2 flex items-center">
          <svg class="group-hover:text-blue-700 w-6 mr-1" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5.121 17.804A13.937 13.937 0 0112 16c2.5 0 4.847.655 6.879 1.804M15 10a3 3 0 11-6 0 3 3 0 016 0zm6 2a9 9 0 11-18 0 9 9 0 0118 0z" />
          </svg>
          <NuxtLink :to="localePath('/online-reception')" class="group-hover:text-blue-700 text-black font-semibold text-xs hover:no-underline">
            Rektor qabulxonasi
          </NuxtLink>
        </li>
        <li class="group bg-gray-200 py-2 px-4 border-r-2 border-l-2 flex items-center">
          ...
          <NuxtLink :to="localePath('/')" class="group-hover:text-blue-700 text-black font-semibold text-xs hover:no-underline">
            Elektron kutubxona
          </NuxtLink>
        </li>
