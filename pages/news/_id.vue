  ...
  <div class="py-10">
    ...
    >
      ...
      <div class="p-2 flex justify-between border-t border-gray-300">
        <span class="text-gray-800 dark:text-gray-300 text-base font-semibold flex items-center">
...
export default {
  async asyncData({ $axios, params, app }) {
    ...
    const postViewsCount = await $axios.$get(`https://admin.uzdsmi-nf.uz/wp-json/base/views/${id}`)
